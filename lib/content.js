...
export const articles = [
  ...
  // NEW ARTICLE 19: OCT Explained (Kept existing, adding metadata)
  {
    slug: 'oct-explained',
    category: 'Imaging',
    tag: 'GUIDE',
    ...
    image: '/images/oct/oct-fundus-ir-overlay.webp',
    imageAlt: 'OCT scan with infrared fundus overlay showing cross-sectional and en face views',
    primaryKeyword: 'OCT imaging',
    secondaryKeywords: ['optical coherence tomography explained', 'how OCT works', 'OCT retina scan'],
  ...
  // NEW ARTICLE 20: Remaining existing articles (3D OCT, ultra-widefield original, retina-window, ai-dr, future imaging, gene therapy original)
  // These stay as-is from the original file for continuity
  {
    slug: 'ai-read-3d-oct',
    category: 'AI',
    tag: 'THE FRONTIER',
